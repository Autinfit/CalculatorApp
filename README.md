...
- **_The purpose of this tutorial is to start learning how to create applications in W.P.F. theme._**
- **_We've built several different codes in the classic Windows Forms app template; However, it is important for us to learn how to use W.P.F. as it is now used more frequently in application and game development._**
...
- **_El propósito de este tutorial es comenzar a aprender a cómo crear aplicaciones en formato WPF._**
- **_Hemos creado varios códigos diferentes en la plantilla de aplicación clásica de Windows Forms; sin embargo, es importante para nosotros aprender a usar W.P.F., ya que ahora se usa con más frecuencia en el desarrollo de aplicaciones y juegos._**
